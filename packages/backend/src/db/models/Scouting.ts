...
import { RegisterResult } from '@scouting-app/shared/dataClasses/OrganizationClass';
import ScoutClass, { LoginResult } from '@scouting-app/shared/dataClasses/ScoutClass';
